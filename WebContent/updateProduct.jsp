				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="FY BBA(CA)-1"
								<%="FY BBA(CA)-1".equalsIgnoreCase(ptype) ? "selected" : ""%>>FY BBA(CA)-1</option>
							<option value="FY BBA(CA)-2"
								<%="FY BBA(CA)-2".equalsIgnoreCase(ptype) ? "selected" : ""%>>FY BBA(CA)-2</option>
							<option value="SY BBA(CA)-3"
								<%="SY BBA(CA)-3".equalsIgnoreCase(ptype) ? "selected" : ""%>>SY BBA(CA)-3</option>
							<option value="SY BBA(CA)-4"
								<%="SY BBA(CA)-4".equalsIgnoreCase(ptype) ? "selected" : ""%>>SY BBA(CA)-4</option>
							<option value="TY BBA(CA)-5"
								<%="TY BBA(CA)-5".equalsIgnoreCase(ptype) ? "selected" : ""%>>TY BBA(CA)-5</option>
							<option value="TY BBA(CA)-6"
								<%="TY BBA(CA)-6".equalsIgnoreCase(ptype) ? "selected" : ""%>>TY BBA(CA)-6</option>
							<option value="other"
