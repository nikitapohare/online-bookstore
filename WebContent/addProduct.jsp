	...
	<div class="container">
		<div class="row"
			...
			<form action="./AddProductSrv" method="post"
				...
				style="border: 2px solid black; border-radius: 10px; background-color: #DAF7A6 ; padding: 10px;">
				<div style="font-weight: bold;" class="text-center">
					<h2 style="color: purple;">Product Addition Form</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="FY BBA(CA)">FY BBA(CA)-1</option>
							<option value="FY BBA(CA)">FY BBA(CA)-2</option>
							<option value="SY BBA(CA)">SY BBA(CA)-3</option>
							<option value="SY BBA(CA)">SY BBA(CA)-4</option>
							<option value="TY BBA(CA)">TY BBA(CA)-5</option>
							<option value="TY BBA(CA)">TY BBA(CA)-6</option>
