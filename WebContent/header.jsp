...
<body style="background-image: url('back3.jpg');">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #F9DB0F; color: black; padding: 5px;">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>BookStore</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=FY BBA(CA)-1">FY BBA(CA)-1</a></li>
							<li><a href="index.jsp?type=FY BBA(CA)-2">FY BBA(CA)-2</a></li>
							<li><a href="index.jsp?type=SY BBA(CA)-3">SY BBA(CA)-3</a></li>
							<li><a href="index.jsp?type=SY BBA(CA)-4">SY BBA(CA)-4</a></li>
							<li><a href="index.jsp?type=SY BBA(CA)-5">TY BBA(CA)-5</a></li>
							<li><a href="index.jsp?type=SY BBA(CA)-6">TY BBA(CA)-6</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=FY BBA(CA)-1">FY BBA(CA)-1</a></li>
							<li><a href="userHome.jsp?type=FY BBA(CA)-2">FY BBA(CA)-2</a></li>
							<li><a href="userHome.jsp?type=SY BBA(CA)-3">SY BBA(CA)-3</a></li>
							<li><a href="userHome.jsp?type=SY BBA(CA)-4">SY BBA(CA)-4</a></li>
							<li><a href="userHome.jsp?type=TY BBA(CA)-5">TY BBA(CA)-5</a></li>
							<li><a href="userHome.jsp?type=TY BBA(CA)-6">TY BBA(CA)-6</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
